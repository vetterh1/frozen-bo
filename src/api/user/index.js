...
const { email, password, name, language, home, homeOrder, mapCategoriesNextIds, picture, role } = schema.tree
...
router.put('/:id',
  token({ required: true }),
  body({ name, language, home, homeOrder, mapCategoriesNextIds, picture }),
  update)
