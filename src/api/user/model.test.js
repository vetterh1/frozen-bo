...
beforeEach(async () => {
  user = await User.create({ name: 'user', email: 'a@a.com', password: '123456', navigationStyle: 1, detailsHelpCompleted: true, language: 'fr', density: 3})
})
...
describe('view', () => {
  it('returns simple view', () => {
    ...
    expect(view.density).toBe(user.density)
